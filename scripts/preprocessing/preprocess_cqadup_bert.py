...
import sys
sys.path.insert(0, "D:/duplicate/MFAE/MFAE")
from mfae.data import Preprocessor


def preprocess_CQADUP_data(inputdir,
                         embeddings_file,
                         targetdir,
                         lowercase=False,
...
if __name__ == "__main__":
    default_config = "../../config/preprocessing/cqadup_preprocessing.json"

    parser = argparse.ArgumentParser(description="Preprocess the cqadup dataset")
    parser.add_argument(
        "--config",
        default=default_config,
        help="Path to a configuration file for preprocessing cqadup"
    )
